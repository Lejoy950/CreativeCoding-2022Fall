...
function setup() {
  ...
  skull2 = new Skull(876, 315, 188, 41, 34);
  spaceman1 = new Spaceman(125, 341, 188, 234, 169);
}
...
function draw() {
  ...
  let green = color(19, 86, 43);
  let darkBlue = color(14, 21, 56);
  let darkCyan = color (68, 97, 109);
  let lightGreen = color(188, 234, 169);
  background(darkBlue);
...
class Spaceman {
  ...
  motion() {
    //moving up and down
    if (this.positionY > 443 || this.positionY < 310) {
      speed = speed * -1;
    }
